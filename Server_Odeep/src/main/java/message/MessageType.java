...
public class MessageType {
    ...
    public final static String DOWN = "DOWN"; //demande au serveur le fichier de conf du groupe
    public final static String UPDT = "UPDT"; //notifier les autre utilisateur du groupe qu'il faut download le ficheir config
