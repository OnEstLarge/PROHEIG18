public class Test {
    ...
    public static void main(String[] args) {
        ...
        PeerMessage peerMessage1 = new PeerMessage("TEST", p2.getID(), p1.getID(), message1.getBytes());
        String message2 = "HOHOHOHOHO";
        PeerMessage peerMessage2 = new PeerMessage("TEST", p2.getID(), p1.getID(), message2.getBytes());
